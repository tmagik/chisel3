...
object Driver extends BackendCompilationUtilities {
  ...
  /**
    ...
    * @param gen A function that creates a Module hierarchy.
    */
  @deprecated("Use chisel3.stage.ChiselStage with '--no-run-firrtl'", "3.2.2")
  ...
  /**
    ...
    */
  @deprecated("Use chisel3.stage.ChiselStage with '-X verilog -E verilog' arguments", "3.2.2")
  ...
  @deprecated("Use chisel3.stage.ChiselStage with a '--target-directory' argument", "3.2.2")
  ...
  @deprecated("This method has no effect on Chisel3 Driver!", "3.2.2")
  ...
  /**
    ...
    */
  @deprecated("Use chisel3.stage.ChiselStage.{execute, transform}", "3.2.2")
 ...
 *
  ...
  /**
    ...
    */
  @deprecated("Use chisel3.stage.ChiselMain", "3.2.2")
